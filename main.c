...
void make_index_html()
{
  ...
  fprintf(fptr, "<head>\n");
  fprintf(fptr, "<title>\n");
  fprintf(fptr, "Web DUO 256 pin multiplexing configuration\n");
  fprintf(fptr, "</title>\n");
  ...
  fprintf(fptr, "</head>\n");
  fprintf(fptr, "<body>\n");
  fprintf(fptr, "<center><h1> Web DUO 256 Pin multiplexing contigurator </h1></center>\n");
  ...
  generated_html_code = generate_html_code_pin("IIC0_SCL", TRUE); // GP0
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("IIC0_SDA", TRUE); // GP1
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");
  ...
  generated_html_code = generate_html_code_pin("JTAG_CPU_TMS", TRUE); // GP2
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("JTAG_CPU_TCK", TRUE); // GP3
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SD1_D2", TRUE); // GP4
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SD1_D1", TRUE); // GP5
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");
  ...
  generated_html_code = generate_html_code_pin("SD1_CLK", TRUE); // GP6
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SD1_CMD", TRUE); // GP7
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SD1_D0", TRUE); // GP8
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SD1_D3", TRUE); // GP9
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");
  ...
  generated_html_code = generate_html_code_pin("PAD_MIPI_TXM1", TRUE); // GP10
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("PAD_MIPI_TXP1", TRUE); // GP11
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("UART0_TX", TRUE); // GP12
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("UART0_RX", TRUE); // GP13
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");
  ...
  generated_html_code = generate_html_code_pin("SD0_PWR_EN", TRUE); // GP14
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SPK_EN", TRUE); // GP15
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  ...
  generated_html_code = generate_html_code_pin("Boot-Switch", FALSE);
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("Audio-Out", FALSE);
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");
  ...
  generated_html_code = generate_html_code_pin("USB_VBUS_DET", TRUE); // GP27
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("ADC1", TRUE); // GP26
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");
  ...
  generated_html_code = generate_html_code_pin("PWR_SEQ2", TRUE); // GP22
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");
  ...
  generated_html_code = generate_html_code_pin("SPINOR_HOLD_X", TRUE); // GP21
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SPINOR_WP_X", TRUE); // GP20
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SPINOR_MOSI", TRUE); // GP19
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SPINOR_SCK", TRUE); // GP18
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");
  ...
  generated_html_code = generate_html_code_pin("SPINOR_CS_X", TRUE); // GP17
  fprintf(fptr, "%s", generated_html_code);
  free(generated_html_code);
  fprintf(fptr, "<br>\n");

  generated_html_code = generate_html_code_pin("SPINOR_MISO", TRUE); // GP16
  fprintf(fptr, "%s", generated_html_code);  
  free(generated_html_code);
